...
const ViewAllCodingQuestions = () => {
    ...
    const handleDeleteTestCase = async (problemId, testCasesId) => {
        try {
            // Use window.confirm() for the delete confirmation
            const isConfirmed = window.confirm("Do you really want to delete this test case?");
            
            if (!isConfirmed) return; // If user cancels, exit the function
    
            // Proceed to delete the test case
            ...
            alert("Error deleting test case. Something went wrong.");
        }
    };
    ...
    const deleteProblem = async (problemId) => {
        try {
            // Use window.confirm() for the delete confirmation
            const isConfirmed = window.confirm("Do you really want to delete this problem?");
            
            if (!isConfirmed) return; // If user cancels, exit the function
    
            // Proceed to delete the coding problem
            ...
            // Show error alert
            alert("Error deleting problem. Something went wrong.");
        }
    };
